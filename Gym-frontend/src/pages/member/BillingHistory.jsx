...
function BillingHistory() {
  ...
  try {
    ...
    doc.text('Amount (Rs.)', 125, startY + 7);  // Changed to Rs.
    ...
    doc.text(`Rs. ${formattedAmount}`, 125, startY + 17);  // Using Rs. instead of ₹
    ...
    doc.text(`Rs. ${formattedAmount}`, 85, finalY + 20);  // Using Rs. instead of ₹
                  ...
                  <tr key={payment._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                        payment.plan === 'PREMIUM' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800'
                      }`}>
                        {payment.plan}
                      </span>
                    </td>
